<template>
  <div class="wrapper">
    <div class="item">
      ...
      <p>
        精选 6
        种清新有活力的配色供君选择，分别有天空蓝，清新绿，柠檬黄，高端黑，真爱紫
        分别是blue(默认),green，yellow,purple,red,black
      </p>
    ...
    <div>
      ...
      <z-button size="small" :loading="loading1" @click="loading1 = !loading1"
        >点击</z-button
      >
      <z-button
        size="normal"
